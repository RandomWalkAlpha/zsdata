...
if __name__ == '__main__':
    order_pq_path = 'level2-md/20211213/v_sse_order.pq'
    trade_pq_path = 'level2-md/20211213/v_sse_trade.pq'
    ...
    transaction = generate_transaction_df(trade_pq_path, order_pq_path)
    print(transaction)

    withdraw = generate_withdraw_df(order_pq_path)
    print(withdraw)
